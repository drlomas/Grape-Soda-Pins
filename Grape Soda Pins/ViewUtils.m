...
- (BOOL)viewOrAnySuperviewIsKindOfClass:(Class)class
{
    ...
    return [self.superview viewOrAnySuperviewIsKindOfClass:class];
}
...
- (void)crossfadeWithDuration:(NSTimeInterval)duration
{
    ...
    id animation = ((id(*)(id, SEL))objc_msgSend)(NSClassFromString(@"CATransition"), @selector(animation));
    
    //objc_msgSend(animation, @selector(setDuration:), duration);
    ((void(*)(id, SEL, NSTimeInterval))objc_msgSend)(animation, @selector(setDuration:), duration);
    
    //objc_msgSend(animation, @selector(setType:), @"kCATransitionFade");
    ((void(*)(id, SEL, NSString*))objc_msgSend)(animation, @selector(setType:), @"kCATransitionFade");
    
    //objc_msgSend(self.layer, @selector(addAnimation:forKey:), animation, nil);
    ((void(*)(CALayer*, SEL, id, NSString*))objc_msgSend)(self.layer, @selector(addAnimation:forKey:), animation, nil);
}
